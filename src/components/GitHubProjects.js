    ...
    return (
      <div id="projectsContainer">
        ...
        <div className="projectRow">
          ...
          <div className="project" onClick={() => this.onProjectClicked("react-sudoku")}>
            <h1 className="projectTitle" >React Sudoku</h1>
            <h4 className="projectDescription" >
              A Sudoku web app written in React to build proficiency with React and front end development.
            </h4>
          </div>
        </div>
      </div>
